package yallashoot.shoot.yalla.com.yallashoot.newapp.core.update;
...
public class InAppUpdateHelper {
    ...
    @Inject
    public InAppUpdateHelper(Context context, Methods methods, SharedPreferencesHelper sharedPreferencesHelper) {
        ...
        appUpdateInfoTask.addOnSuccessListener(appUpdateInfo -> {
            ...
            if (
                    appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                            ...
                            (methods.getDaysDiffBetweenTwoDate(sharedPreferencesHelper.getLastUpdateMessage()) >= 30
                                    || appUpdateInfo.availableVersionCode() > sharedPreferencesHelper.getLastUpdateVersionMessage())) {
                // Request the update.
                ...
                sharedPreferencesHelper.setLastUpdateMessage(System.currentTimeMillis());
                sharedPreferencesHelper.setLastUpdateVersionMessage(appUpdateInfo.availableVersionCode());
